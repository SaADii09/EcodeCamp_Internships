/*! For license information please see main.65d91727.js.LICENSE.txt */
!(function () {
	var e = {
			888: function (e, n, t) {
				"use strict";
			...
			463: function (e, n, t) {
				...
				function Kr(e, n, t, r, l) {
					for (var a = n._reactName, o = []; null !== t && t !== r; ) {
						...
						5 === i.tag &&
							...
							((i = s),
							l
								? null != (u = je(t, a)) && o.unshift(Wr(t, u, i))
								: l || (null != (u = je(t, a)) && o.push(Wr(t, u, i)))),
							(t = t.return);
					}
				...
				var Va = {
					...
					enqueueSetState: function (e, n, t) {
						...
						(a.payload = n),
							...
							null !== (n = Oa(e, a, l)) && (ts(n, e, l, r), Ra(n, e, l));
					},
					...
					enqueueForceUpdate: function (e, n) {
						...
						(l.tag = 2),
							...
							null !== (n = Oa(e, l, r)) && (ts(n, e, r, t), Ra(n, e, r));
					},
				};
				...
				function Pi(e, n, t, r, l) {
					...
					if ((Ea(n, l), null === n.stateNode))
						Bi(e, n), Ba(n, t, r), Wa(n, t, r, l), (r = !0);
					else if (null === e) {
						var o = n.stateNode,
							i = n.memoizedProps;
						o.props = i;
						...
						i !== f || d !== h || zl.current || Ta
							? ("function" === typeof p &&
									(Aa(n, t, p, r), (h = n.memoizedState)),
							  (s = Ta || $a(n, t, s, r, d, h, u) || !1)
									? (c ||
					...
					if (null !== (o = e.memoizedState) && null !== (r = o.dehydrated))
						return (function (e, n, t, r, l, o, i) {
							...
							if (((u = 0 !== (i & e.childLanes)), ki || u)) {
								...
								return ms(), Ui(e, n, i, (r = fi(Error(a(421)))));
							}
							return "$?" === l.data
								? ((n.flags |= 128),
								  (n.child = e.child),
				...
				function qi(e, n, t) {
					...
					switch ((na(n), n.tag)) {
						...
						case 4:
							return (
								lo(), null === e && $r(n.stateNode.containerInfo), Qi(n), null
							);
						case 10:
				...
				function _s(e, n, t) {
					...
					null !== r && r.delete(n),
						...
						zu === e &&
							(Lu & t) === t &&
							(4 === Ou ||
							(3 === Ou && (130023424 & Lu) === Lu && 500 > Ge() - Vu)
								? ds(e, 0)
								: (Du |= t)),
						rs(e, n);
				}
				...
				function Hs(e, n, t, r) {
					...
					return (
						...
						null !== (e = Oa(l, n, o)) && (ts(e, l, o, a), Ra(e, l, o)),
						o
					);
				}
				function Ws(e) {
	...
	(t.n = function (e) {
		...
		(function () {
			...
			var u = t(7),
				...
				y = function (e, n) {
					for (var t in n || (n = {})) m.call(n, t) && g(e, t, n[t]);
					if (h) {
						var r,
							l = i(h(n));
						try {
			...
			var x = function () {
					...
					return (0, S.jsxs)(S.Fragment, {
						children: [
								...
								children: [
									...
									(0, S.jsxs)("ul", {
										children: [
											o.map(function (e) {
												return (0,
												S.jsx)("li", { children: (0, S.jsx)("a", { href: e.link, children: e.name }) }, e.name);
											}),
											(0, S.jsx)("li", {
												onClick: function () {
													return l();
							...
							(0, S.jsxs)("div", {
								className: "mobile-nav ".concat(
									t ? "open-menu" : "closed-menu"
								),
								children: [
									(0, S.jsx)("span", {
										onClick: function () {
										...
										children: (0, S.jsx)(w, { width: 30, height: 30 }),
									}),
									(0, S.jsx)("ul", {
				...
				_ = b("brand-linkedin", "IconBrandLinkedin", [
					[
						"path",
						{
				...
				C = b("brand-github", "IconBrandGithub", [
					[
						"path",
						{
			...
			var P = function () {
											...
											children: [
												(0, S.jsxs)("div", {
													...
													children: [
														...
														(0, S.jsx)("img", { src: E, alt: "waving_hand" }),
														(0, S.jsx)("p", {
															children:
												...
												(0, S.jsx)("div", { className: "hero-img" }),
											],
										}),
										(0, S.jsxs)("div", {
											className: "skills",
											children: [
												(0, S.jsx)("p", { children: "Tech Stack" }),
												(0, S.jsx)("div", {
													className: "logos",
													children: (0, S.jsx)("ul", {
														children: N.map(function (e) {
															return (0,
															S.jsx)("li", { children: (0, S.jsx)("img", { src: e.img, alt: "skill-icon" }) }, e.id);
														}),
													}),
												}),
											],
				...
				z = t.p + "static/media/about-img.62b47e7f183d4b4e9feb.webp";
			var T = t.p + "static/media/text2.3d5aa6ba2d0632bb4e0572631c3f9dc2.svg",
				L = t.p + "static/media/working-emoji.c5325f52b5be329995a5.png";
			var j = function () {
				return (0, S.jsx)(S.Fragment, {
					children: (0, S.jsx)("section", {
						className: "about",
								...
								children: [
									(0, S.jsxs)("div", {
										...
										children: [
											...
											(0, S.jsx)("span", {
												children: (0, S.jsx)("img", { src: T, alt: "text" }),
											}),
										],
									}),
									(0, S.jsxs)("div", {
										...
										children: [
											...
											(0, S.jsxs)("p", {
												children: [
													"Hey, my name is Stefan, and I'm a Frontend Developer. My passion is to create and develop a clean UI/UX for my users.",
													(0, S.jsx)("br", {}),
													(0, S.jsx)("br", {}),
			...
			var M = function () {
				...
				O = b("map-search", "IconMapSearch", [
					[
						"path",
						{ d: "M11 18l-2 -1l-6 3v-13l6 -3l6 3l6 -3v7.5", key: "svg-0" },
					],
					["path", { d: "M9 4v13", key: "svg-1" }],
					["path", { d: "M15 7v5", key: "svg-2" }],
					[
						"path",
						{ d: "M18 18m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0", key: "svg-3" },
					],
									...
									(0, S.jsxs)("div", {
										...
										children: [
											(0, S.jsxs)("div", {
												...
												children: [
													(0, S.jsx)("span", {
														children: (0, S.jsx)(O, { width: 30, height: 30 }),
													}),
													(0, S.jsxs)("div", {
														className: "contact__info",
														children: [
															(0, S.jsx)("h3", { children: "Location" }),
															(0, S.jsx)("p", { children: "Belgrade, Serbia" }),
														],
													}),
												],
											}),
											(0, S.jsxs)("div", {
												...
												children: [
													(0, S.jsx)("span", {
														children: (0, S.jsx)(R, { width: 30, height: 30 }),
													}),
													(0, S.jsxs)("div", {
														className: "contact__info",
														children: [
															(0, S.jsx)("h3", { children: "Mail" }),
															(0, S.jsx)("a", {
																href: "mailto:stefan.topallovic@gmail.com",
																children: "stefan.topallovic@gmail.com",
															}),
														],
													}),
												],
									...
									(0, S.jsxs)("div", {
										...
										children: [
											(0, S.jsx)("a", {
												...
												rel: "noreferrer",
												href: "https://www.linkedin.com/in/stefan-topalovic-dev/",
												children: (0, S.jsx)(_, { width: 30, height: 30 }),
											}),
											(0, S.jsx)("a", {
												"aria-label": "github",
												target: "_blank",
												rel: "noreferrer",
												href: "https://github.com/stefvndev",
												children: (0, S.jsx)(C, { width: 30, height: 30 }),
											}),
										],
									}),
								],
			...
			var U = function () {
				return (0, S.jsx)(S.Fragment, { children: (0, S.jsx)(D, {}) });
			};
			n.createRoot(document.getElementById("root")).render(
				(0, S.jsx)(e.StrictMode, { children: (0, S.jsx)(U, {}) })
			);
		})();
})();
//# sourceMappingURL=main.65d91727.js.map
